...
/*--------------------show Appendix-------------------------*/
	var i_app = -1, y_app = 0;
(function showAppendix(appendix, circle, beforeEl, targetM, targetL, targetP, circleLayout) { // spinning
	...
	if (i_app <= 20 && y_app <= 20) {
		i_app++; y_app++;
	return showAppendix(appendixes[i_app], buttons[i_app], buttons[y_app], overlay[i_app], mainCircle[i_app], p_AppButton[i_app], circlePositioner[i_app]);
	}
